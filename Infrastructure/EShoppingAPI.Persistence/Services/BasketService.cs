...
using EShoppingAPI.Application.ViewModles.Basket;
...
namespace EShoppingAPI.Persistence.Services
{
    public class BasketService : IBasketService
    {
        ...
        private async Task<Basket?> ContextUser()
        {
            ...
            throw new Exception("another worning!");
        }
        ...
        public async Task AddItemToBasketAsync(VM_Create_BasketItem basketItem)
        {
            ...
            if (basket != null)
            {
             BasketItem _basketItem = await  _basketItemReadRepository.GetStringAsync(b => b.BasketId == basket.Id && b.ProductId == Guid.Parse(basketItem.ProductId));
                if (_basketItem != null)
